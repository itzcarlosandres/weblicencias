                ...
                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors group">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex items-center justify-end gap-1">
                            ...
                            <form action="{{ route('admin.orders.send-reminder', $order) }}" method="POST" class="inline" onsubmit="return confirm('¿Deseas enviar un recordatorio de pago a este cliente?');">
                                @csrf
                                <button type="submit" class="p-2 text-gray-400 hover:text-amber-500 hover:bg-amber-50 dark:hover:bg-amber-900/20 rounded-lg transition-all" title="Enviar Recordatorio">
