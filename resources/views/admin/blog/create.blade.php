...
@section('header')
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white tracking-tight">Nuevo Artículo</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Crea contenido optimizado para SEO.</p>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="excerpt" id="post-excerpt" rows="2" class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block p-3.5" placeholder="Un resumen persuasivo del artículo...">{{ old('excerpt') }}</textarea>
                    @error('excerpt') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Contenido (HTML) *</label>
                    <textarea name="content" id="post-content" rows="15" required class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block p-3.5 font-mono" placeholder="<h2>Introducción</h2><p>Texto aquí...</p>">{{ old('content') }}</textarea>
        ...
        <div class="space-y-6">
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
                ...
                <label class="relative inline-flex items-center cursor-pointer mb-6">
                    ...
                    <span class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">Publicar Inmediatamente</span>
                </label>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">Recomendado: 1200x630px</p>
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="meta_title" id="post-meta-title" value="{{ old('meta_title') }}" class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block p-3">
                </div>

                <div>
                    <label class="block text-xs font-bold text-gray-700 dark:text-gray-300 mb-2">Meta Descripción</label>
                    <textarea name="meta_description" id="post-meta-description" rows="3" class="w-full bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block p-3">{{ old('meta_description') }}</textarea>
                </div>
            </div>
        </div>
    </div>
