            ...
            <div class="bg-white dark:bg-[#111827] rounded-2xl border border-gray-200/60 dark:border-gray-800/60 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="important_note" id="important_note" rows="4" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl text-[13px] text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-400/30 focus:border-primary-400 transition-all resize-none" placeholder="Ej: Requisitos de activación, VPN, etc...">{{ old('important_note') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-[#111827] rounded-2xl border border-gray-200/60 dark:border-gray-800/60 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        @php
                        // No longer using hardcoded platforms, using $platforms passed from controller
                        @endphp
                        <div class="flex flex-wrap gap-2 mb-2">
                            ...
                            <button type="button"
                                ...
                                @if($cp->image)
                                    <img src="{{ asset('storage/' . $cp->image) }}" class="w-4 h-4 object-contain">
                                @elseif($cp->icon)
                                    <i class="{{ $cp->icon }} text-[#555] w-4 text-center"></i>
                                @endif
                                {{ $cp->value }}
                            </button>
                            @endforeach
                    ...
                    <div>
                        ...
                        <input list="regions-list" name="region" value="{{ old('region') }}" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl text-[13px] text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-400/30 focus:border-primary-400 transition-all" placeholder="Ej: Global, Latinoamérica" autocomplete="off">
                    ...
                    <div>
                        ...
                        <input list="activation-methods-list" name="activation_method" value="{{ old('activation_method') }}" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl text-[13px] text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-400/30 focus:border-primary-400 transition-all" placeholder="Ej: Online, por teléfono" autocomplete="off">
                        <datalist id="activation-methods-list">
