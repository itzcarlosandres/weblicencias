                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            @php
                            $editPlatforms = [
                                ['value' => 'Windows', 'label' => 'Windows', 'icon' => 'M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801', 'color' => '#0078D4'],
                                ['value' => 'macOS', 'label' => 'macOS', 'icon' => 'apple', 'color' => '#555'],
                                ['value' => 'Android', 'label' => 'Android', 'icon' => 'android', 'color' => '#3DDC84'],
                                ['value' => 'iOS', 'label' => 'iOS', 'icon' => 'apple', 'color' => '#888'],
                                ['value' => 'Steam', 'label' => 'Steam', 'icon' => 'steam', 'color' => '#1b2838'],
                                ['value' => 'PlayStation', 'label' => 'PlayStation', 'icon' => 'ps', 'color' => '#003087'],
                                ['value' => 'Xbox', 'label' => 'Xbox', 'icon' => 'xbox', 'color' => '#107C10'],
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="text" id="edit_platform_custom"
                                    ...
                                    value="{{ !in_array($editCurrentPlatform, $editPlatformValues) && $editCurrentPlatform ? $editCurrentPlatform : '' }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="region" value="{{ old('region', $product->region) }}" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl text-[13px] text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-400/30 focus:border-primary-400 transition-all" placeholder="Ej: Global, Latinoamérica">
                        </div>
                    </div>
                    <script>
                    (function() {
                    ...
                    <div>
                        ...
                        <input type="text" name="activation_method" value="{{ old('activation_method', $product->activation_method) }}" class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl text-[13px] text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-400/30 focus:border-primary-400 transition-all" placeholder="Ej: Online, por teléfono">
                    </div>
                </div>
            </div>
        </div>
