        ...
        <aside id="admin-sidebar" class="admin-sidebar-layout w-[260px] bg-white dark:bg-[#111827] border-r border-gray-200/80 dark:border-gray-800/60 flex flex-col shrink-0 fixed h-full z-30 transition-transform duration-300">
            ...
            <nav class="flex-1 overflow-y-auto admin-sidebar py-4 px-3">
                ...
                <div class="mb-6">
                    ...
                    <a href="{{ route('admin.blacklist.index') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 text-[13px] font-medium rounded-lg {{ request()->routeIs('admin.blacklist.*') ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 active' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                        <i class="fa-solid fa-shield-halved w-[18px] text-center text-lg"></i>
                        Seguridad (Blacklist)
                    </a>
                </div>
            </nav>
