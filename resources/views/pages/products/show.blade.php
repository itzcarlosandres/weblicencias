                ...
                <div class="grid grid-cols-2 gap-y-6 gap-x-4">
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-sm font-bold text-gray-900">{{ $product->platform ?? 'PC' }}</div>
                        </div>
                    </div>
