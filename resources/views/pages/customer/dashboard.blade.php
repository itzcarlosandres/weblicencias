        ...
        <aside class="w-full lg:w-64 shrink-0 lg:sticky lg:top-36 h-max">
            <div class="bg-white rounded-2xl border border-gray-100 p-6">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('customer.referrals') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm rounded-xl {{ request()->routeIs('customer.referrals') ? 'bg-primary-50 text-primary-600' : 'text-text-secondary hover:bg-gray-50 ' }}">
